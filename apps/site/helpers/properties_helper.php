...
ipsCore::requires_model(['property', 'property_type']);
	...
	public function sync()
	{
		if (!empty($this->api_properties)) {
			...
			foreach ($this->api_properties as $api_property) {
				...
				if (!$property_in_db || ($property_in_db->modified != null && ($property_in_db->get_prop('modified') == $property_in_db->get_prop('created')))) {
					...
					$property_in_db->set_prop('image', '');
					$property_in_db->set_prop('thumbnail', '');
